                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-end">
                                <div class="btn-group">
                                    <?php
                                    $prev_url = "?week=".($current_week-1)."&year=$current_year&view_type=$view_type";
                                    $next_url = "?week=".($current_week+1)."&year=$current_year&view_type=$view_type";
...
// насосал на запрет, хз должно работать
